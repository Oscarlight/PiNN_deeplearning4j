...
public class LSMTNetwork {
	...
	public LSMTNetwork(int seed, double learningRate, int nEpochs, int batchSize,
	 ...
	 */
	private MultiDataSetIterator readData(String dir) throws IOException, InterruptedException {
    ...
    public static void main(String[] args) throws Exception{
        ...
        LSMTNetwork pinn = new LSMTNetwork(seed, learningRate, nEpochs, batchSize,
...
//        Plot.linePlot(trainIter);
        ...
        /* Save the model */
        File locationToSave = new File("dc-pinn.zip");       			//Where to save the network. Note: the file is in .zip format - can be opened externally
