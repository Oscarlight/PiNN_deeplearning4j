...
public class MultiTimestepRegression {
    private static final Logger LOGGER = LoggerFactory.getLogger(MultiTimestepRegression.class);

    private static File baseDir = new File("rnnRegression");
